...
999,1105,1,46,1101,1000,1,20,4,20,1105,1,46,98,99 }, 9, 1001
        ...
        private static readonly object[] _sourceListsDay7 =
        {
            new object[]
            {
                new List<int> { 3,15,3,16,1002,16,10,16,1,16,15,15,4,15,99,0,0 },
            ...
            new object[]
            {
                new List<int> { 3,23,3,24,1002,24,10,24,1002,23,-1,23,101,5,23,23,1,24,23,23,4,23,99,0,0 },
            ...
            new object[]
            {
                new List<int> {3,31,3,32,1002,32,10,32,1001,31,-2,31,1007,31,0,33,1002,33,7,33,1,33,31,31,1,32,31,31,4,31,99,0,0,0 },
        ...
        private static readonly object[] _sourceListsDay7Part2 =
{
            new object[]
            {
                new List<int> { 3,26,1001,26,-4,26,3,27,1002,27,2,27,1,27,26,27,4,27,1001,28,-1,28,1005,28,6,99,0,0,5 },
            ...
            new object[]
            {
                new List<int> { 3,52,1001,52,-5,52,3,53,1,52,56,54,1007,54,5,55,1005,55,26,1001,54,
...
53,1001,56,-1,56,1005,56,6,99,0,0,0,0,10 },
        ...
        {
            var io = new IntCodeComputerIO(new List<int>());
        ...
        {
            var io = new IntCodeComputerIO(new List<int>() { 1 });
        ...
        {
            var io = new IntCodeComputerIO(new List<int>() { input });

            int output = default;
            var outputFunc = new DelegateOutput((int i) => output = i);
        ...
        public void Day7Test(List<int> code, List<int> phaseSequence, int expectedOutput)
        {
        ...
        public void Day7TestPart2(List<int> code, List<int> phaseSequence, int expectedOutput)
        {
            var amply = new AmplificationCircuitConfig(code, phaseSequence);
